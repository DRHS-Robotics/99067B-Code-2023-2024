...
initializeTapaTask();
    ...
    // slapper.move(100);
	intake2.move(127);
	arcTurn.BArcTurn(88.0, 9.0, 110, 0.015);
	Drive.control_drive_back(600, 127, 88);
	Drive.control_drive(300, 127, 88);
	// Drive.control_drive(600, 127, 88);
	// Drive.control_drive_back(200, 127, 88);
    frontSlapaState = true;
	// flywheelOn = true;
	// targetVoltage = 6500;
	control_turn(82, 110, 0.42, 3, false, false);
	Drive.control_drive(600, 120, 262);
	control_turn(340, 100, 0.017, 3.5, false, false);
	Drive.control_drive_back(100, 100, 341);
	wings2.set_value(true);
	pros::delay(30000); //Run slapper for 32 seconds
	wings2.set_value(false);
    intake2.move(0);
	control_turn(29, 110, 0.03, 3.5, false, false);
	Drive.control_drive(900, 120, 29);
	control_turn(0, 100, 0.1, 3.5, false, false);
	Drive.control_drive(2150, 120, 0);
	frontSlapaState = false;
	arcTurn.FArcTurn(222, 5.0, 110, 0.008);
	// Drive.control_drive(900, 120, 97);
	// Drive.control_drive_back(650, 127, 97);
	//control_turn(45, 100, 0.009);
	Drive.control_drive(1350, 120, 222);
	control_turn(267, 127, 0.02, 3.5, true, false);
	Drive.control_drive(1650, 120, 267);
    control_turn(195, 70, 0.015, 3.5, false, false);
    ...
    // wings1.set_value(true);
	// wings2.set_value(true);
	Drive.control_drive_back(1300, 127, 15);
	Drive.control_drive(900, 120, 15);
    wings1.set_value(false);
	wings2.set_value(false);
    //control_turn(0, 110, 0.05, 3.5, false, false);
    arcTurn.FArcTurn(90, 40, 100, 0.01);
	Drive.control_drive(700, 100, 90);
    control_turn(160, 100, 0.015, 3.75, false, false);
    wings1.set_value(true);
	wings2.set_value(true);
	Drive.control_drive_back(1400, 127, 160);
	Drive.control_drive(600, 120, 160);
	wings1.set_value(false);
	wings2.set_value(false);
    control_turn(225, 100, 0.015, 3.75, false, false);
    Drive.control_drive_back(400, 127, 225);
    arcTurn.BArcTurn(90, 40, 100, 0.01);
    Drive.control_drive_back(1400, 127, 90);
	Drive.control_drive(600, 120, 90 );
...
void opcontrol() {
   ...
   Drive.set(0);
	...
	control_turn(82, 110, 0.42, 3, false, false);
	Drive.control_drive(600, 120, 262);
	control_turn(341, 100, 0.017, 3.5, false, false);
	Drive.control_drive_back(100, 100, 341);
	wings2.set_value(true);
